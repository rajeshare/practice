...
import FareStrategyPattern.Concrete.HourLyParkingFeeStrategy;
import FareStrategyPattern.Concrete.PremiumParkingFeeStrategy;
import FareStrategyPattern.ParkingFeeStrategy;
import ParkingController.ParkingLot;
import ParkingSpot.ParkingSpot;
import ParkingSpot.concrete.BikeParkingSpot;
import ParkingSpot.concrete.CarParkingSpot;
import PaymentStategy.Concrete.CashPayment;
import PaymentStategy.Concrete.CreditCardPayment;
...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        ParkingFeeStrategy basicHourlyRateStrategy = new HourLyParkingFeeStrategy();
        ParkingFeeStrategy premiumRateStrategy = new PremiumParkingFeeStrategy();
